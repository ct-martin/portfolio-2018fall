<template>
  <article class="container">
    ...
    <p>Student studying New Media Interactive Development at the Rochester Institute of Technology.</p>

    <h2 id="contact">Contact Info</h2>
    <ul class="list-group">
      <li class="list-group-item"><span aria-hidden="true" class="fa fa-fw fa-github"></span> GitHub: <a href="https://github.com/ct-martin" target="_blank">@ct-martin</a></li>
      <!--sse--><li class="list-group-item"><span aria-hidden="true" class="fa fa-fw fa-envelope"></span> Email: <a href="mailto:hello@ctmartin.me">hello@ctmartin.me</a></li>
      <li class="list-group-item"><span aria-hidden="true" class="fa fa-fw fa-comments-o"></span> IRC: ctmartin in #ritlug, #rit-foss on <a href="https://freenode.net/" target="_blank">FreeNode</a>.</li>
