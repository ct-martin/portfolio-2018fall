  ...
  <section class="hero is-medium is-info is-bold">
    <div class="hero-body">
      <div class="container">
        ...
        <h2 class="subtitle">
          Front-End Developer, Full Stack Engineer, Creative Technologist, Computing Generalist; Studying New Media Interactive Development at Rochester Institute of Technology.
        </h2>
      </div>
    </div>
  </section>
    ...
    <div class="columns is-multiline">
      ...
      <div class="column is-6-tablet">
        <div class="box has-background-success">
          <h3 class="title has-text-white">Cloud</h3>
          <custom-list-group source="content" tag="home-cloud" />
        </div>
      </div>
      <div class="column is-6-tablet">
      ...
      <div class="column is-6-tablet">
        <div class="box has-background-danger">
          <h3 class="title has-text-white">More</h3>
